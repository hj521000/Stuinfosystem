...
<html>
  ...
  <body background="bg.jpeg">
    ...
    <%
    	...
    	switch(choice_int){
    		case 1:{
    			out.print("<center><form action='dochange/addInfo.jsp' method='post'>"+
    		...
    		case 4:{
    			out.print("<center><form action='dochange/addInfo.jsp' method='post'>"+
    			"教师姓名 ：<input type='text' name='tea_name'><br>教师编号 ：<input type='text' name='tea_id'>"+
    			"<br>教师生日 ：<input type='text' name='tea_birth'><br><input type='submit' value='添加教师信息'>"+
    			"</form></center>");
    		};break;
    		case 5:{
    			out.print("<center><form action='dochange/changeInfo.jsp' method='post'>"+
    			"教师编号 ：<input type='text' name='tea_id'><br>教师姓名 ：<input type='text' name='tea_name'>"+
    			"<br>教师生日 ：<input type='text' name='tea_birth'><br><input type='submit' value='修改教师信息'>"+
    			"</form></center>");
    		};break;
    		case 6:{
    			out.print("<center><form action='dochange/deleteInfo.jsp' method='post'>"+
    			"教师学号 ：<input type='text' name='tea_id'><br>"+
    			"<input type='submit' value='删除教师信息'>"+
    			"</form></center>");
    		};break;    		
    	...
    	out.print("<br><br><a href='admin.jsp'>返回重新选择</a> <a href='login.jsp'>返回首页</a>");
     %>
     </center>
  </body>
</html>